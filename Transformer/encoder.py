...
class EncoderLayer(nn.Module):
    def __init__(self, args):
        ...
        # fnn前的归一化处理
        self.fnn_norm = LayerNorm(args.model_dim)
        # 前馈神经网络
        self.fnn = FNN(args.model_dim, args.embd_dim, args.dropout)
...
class Encoder(nn.Module):
    def __init__(self, args):
        ...
        self.layers = nn.ModuleList([EncoderLayer(args) for _ in range(args.encoderLayerNum)])
